...
export default function NavMenu() {
  ...
  return (
    <>
      <li>
        <Link href="/home" className={style.tag}>
          <div className={style.navPill}>
            {segment === "home" ? (
              <>
                ...
                <div style={{ fontWeight: "bold" }} className={style.text}>
                  홈
                </div>
              </>
            ) : (
      ...
      <li>
        <Link href="/explore" className={style.tag}>
          <div className={style.navPill}>
      ...
      <li>
        <Link href="/messages" className={style.tag}>
          <div className={style.navPill}>
            {segment === "messages" ? (
              <>
                <svg
      ...
      {me?.id && (
        <li>
          <Link href={`/${me?.id}`} className={style.tag}>
            <div className={style.navPill}>
              {segment === me.id ? (
                <>
                  <svg
